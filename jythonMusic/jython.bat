@echo off
rem jython.bat		Version 2.0	02-Feb-2021	(bzm)
rem
...
rem within one directory to facilitate ease of installation and execution.
rem
...
REM updated to Jython 2.7.2 (final release)
java -Xmx4096m -Dsun.sound.useNewAudioEngine=true "-Dpython.home=." -classpath "%CD%\library;%CD%\library\jython2.7.2\jython.jar;%CD%\library\jython2.7.2\Lib;%CD%\library\jMusic1.7\jmusic.jar;%CD%\library\jMusic1.7\inst;%CD%\library\jsyn\jsyn.jar;%CD%\library\imgscalr-lib-4.2\imgscalr-lib-4.2.jar;%CD%\library\javaosc-core.jar%CLASSPATH%"  org.python.util.jython %ARGS%
REM java -Xmx1024m "-Dpython.home=." -classpath "%CD%\library;%CD%\library\jython2.7.2\jython.jar;%CD%\library\jython2.7.2\Lib;%CD%\library\jMusic1.7\jmusic.jar;%CD%\library\jMusic1.7\inst;%CD%\library\jsyn\jsyn.jar;%CD%\library\imgscalr-lib-4.2\imgscalr-lib-4.2.jar;%CD%\library\javaosc-core.jar%CLASSPATH%"  org.python.util.jython %ARGS%
REM #Unix command line for comparison - make it as similar as possible# java -Xmx4096m -Dsun.sound.useNewAudioEngine=true -Dpython.home="." -classpath "./library:./library/jython2.7.2/jython.jar:./library/jython2.7.2/Lib:./library/jMusic1.7/inst:./library/jMusic1.7/jmusic.jar:./library/jsyn/jsyn.jar:./library/imgscalr-lib-4.2/imgscalr-lib-4.2.jar:./library/javaosc-core.jar${CLASSPATH}" "org.python.util.jython" "-u" "$@"
