...
public class RealtimeSimpleFMInst extends jm.audio.Instrument{
	//----------------------------------------------
	// Attributes
	//---------------------------------------------
	 ...
	 */
	public RealtimeSimpleFMInst(int sampleRate, int modIndex, double ratio){
	 ...
	 */
	public RealtimeSimpleFMInst(int sampleRate, int modIndex, double ratio, int channels){
	...
	*/
	public void setModulationIndex(int modIndex) {
        this.modIndex = modIndex;
	}	
	
	/**
	* Getter for modulation index.
	*/
	...
	/**
	* Setter for frequency ratio.
	*/
	public void setFrequencyRatio(double ratio) {
        this.frqRatio = (float)ratio;
	}	
	
	/**
	* Getter for frequency ratio.
	*/
	public float getFrequencyRatio() {
        return this.frqRatio;
	}	
