...
public class RealtimeSawLPFInst extends Instrument{
	//----------------------------------------------
	// Attributes
	//----------------------------------------------
	 ...
	 * @param sampleRate 
	 */
	public RealtimeSawLPFInst(int sampleRate){
        ...
        */
    public RealtimeSawLPFInst(int sampleRate, int filterCutoff){
	...
	/**
		...
		*/
	public RealtimeSawLPFInst(int sampleRate, int filterCutoff, int channels){
		this.sampleRate = sampleRate;
		this.filterCutoff = filterCutoff;
