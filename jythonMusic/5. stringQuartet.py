...
violin1.addNoteList(pitches1, durations1)   # add notes to the phrase
...
violin2.addNoteList(pitches2, durations2)   # add notes to the phrase
...
violin3.addNoteList(pitches3, durations3)   # add notes to the phrase
...
violin4.addNoteList(pitches4, durations4)   # add notes to the phrase
